<h1 align="center" style="color:red;">Welcome To My Account</h1>
...
![My Skills](https://skillicons.dev/icons?i=js,html,css,tailwind,bootstrap,angular,react,net,php,cs,figma,rider,lua,ts,nodejs,python,git,github,photoshop)
